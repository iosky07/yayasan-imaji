    ...
    <x-data-table :data="$data" :model="$faqs">
        <x-slot name="head">
            <tr>
                ...
                <th><a wire:click.prevent="sortBy('answer')" role="button" href="#">
                    Jawaban
                    @include('components.sort-icon', ['field' => 'answer'])
                </a></th>
            ...
            @foreach ($faqs as $m)
                <tr x-data="window.__controller.dataTableController({{ $m->id }})">
                    ...
                    <td class="whitespace-no-wrap row-action--icon">
                        <a role="button" href="{{route('admin.faq.edit', $m->id)}}" class="mr-3"><i class="fa fa-16px fa-pen"></i></a>
