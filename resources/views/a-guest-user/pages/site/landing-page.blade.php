@extends('a-guest-user.layouts.master')
            ...
            <div class="row">
                <div class="col-lg-7 col-md-6 col-xs-12">
                    <div class="left-text-content">
                        <div class="section-heading">
                            <h6>About Us</h6>
                            <h2>Politeknik Keuangan Negara</h2>
                        </div>
                ...
                <div class="col-lg-5 col-md-6 col-xs-12">
                    <div class="right-content">
                        <div class="thumb">
                            <img src="{{asset('assets/img/logo-stan.png')}}" alt="">
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-4">
                    <div class="section-heading">
                        <h6>Our Blogs</h6>
                        <h2>Berita terbaru dalam kegiatan kami</h2>
                    </div>
                </div>
            </div>
        </div>
                                ...
                                <div class="row">
                                    <div class="col-lg-6 offset-lg-3">
                                        <ul>
                                            ...
                                            <li><a href='#tabs-2'><img src="assets/images/tab-icon-02.png" alt="">Lunch</a></a>
                                            </li>
                                            <li><a href='#tabs-3'><img src="assets/images/tab-icon-03.png" alt="">Dinner</a></a>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
